...
public class HomeController {
    ...
    @RequestMapping(value = "/addNewShippingAddress", method = POST)
    ...
    @RequestMapping(value = "/setDefaultPayment", method = POST)
    ...
    @RequestMapping(value = "/setDefaultShippingAddress", method = POST)
